...
- ``/HideButton`` or ``/hb``
  ...
  Con este parámetro se ocultan botones específicos (3 dígitos: Apagar/Reiniciar/Bloquear) **(disponible desde [v4.3](https://github.com/mlibre2/myLogin/releases/tag/4.3))** 
