...
#pragma compile(FileVersion, 4.6)					; auto-incremental by workflows (compile)
#pragma compile(LegalCopyright, © by mlibre2)
#pragma compile(OriginalFilename, myLogin.exe)
#pragma compile(ProductName, myLogin)
#pragma compile(ProductVersion, 4.6)				; auto-incremental by workflows (compile)
...
; configurations
Const $g_sVersion = "4.6"								; auto-incremental by workflows (compile)
